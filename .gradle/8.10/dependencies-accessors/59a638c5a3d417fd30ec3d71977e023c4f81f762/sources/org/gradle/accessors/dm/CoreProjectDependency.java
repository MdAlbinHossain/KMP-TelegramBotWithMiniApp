...
public class CoreProjectDependency extends DelegatingProjectDependency {
    ...
    /**
     * Creates a project dependency on the project at path ":core:core"
     */
    public Core_CoreProjectDependency getCore() { return new Core_CoreProjectDependency(getFactory(), create(":core:core")); }
